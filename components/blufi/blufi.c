...
static void bluefi_event_callback(esp_blufi_cb_event_t event, esp_blufi_cb_param_t *param)
{
    ...
    case ESP_BLUFI_EVENT_SET_WIFI_OPMODE:
        BLUFI_INFO("ESP_BLUFI_EVENT_SET_WIFI_OPMODE %d\n", param->wifi_mode.op_mode);
    ...
    case ESP_BLUFI_EVENT_REPORT_ERROR:
        BLUFI_ERROR("ESP_BLUFI_EVENT_REPORT_ERROR, error code %d\n", param->report_error.state);
        esp_blufi_send_error_info(param->report_error.state);
        break;
    case ESP_BLUFI_EVENT_GET_WIFI_STATUS:
    	BLUFI_INFO("EVENT_GET_WIFI_STATUS");
    {
        wifi_mode_t mode;
        esp_blufi_extra_info_t info;
        ...
        BLUFI_INFO("info.sta_bssid_set: %d",info.sta_bssid_set);
        ESP_LOG_BUFFER_CHAR("BLUFI_EXAMPLE: info.sta_ssid", gl_sta_ssid, sizeof(gl_sta_ssid));
        BLUFI_INFO("WiFi Mode: %i", mode);
        BLUFI_INFO("info.sta_ssid_lenght %i:", gl_sta_ssid_len);
        ESP_LOG_BUFFER_HEX("info", &info, sizeof(info));

        break;
    }
    case ESP_BLUFI_EVENT_RECV_SLAVE_DISCONNECT_BLE:
        BLUFI_INFO("ESP_BLUFI_EVENT_RECV_SLAVE_DISCONNECT_BLE close a gatt connection");
        esp_blufi_disconnect();
        break;
    case ESP_BLUFI_EVENT_DEAUTHENTICATE_STA:
        /* TODO */
        BLUFI_INFO("EVENT_DEAUTHENTICATE_STA");
        break;
	case ESP_BLUFI_EVENT_RECV_STA_BSSID:
		BLUFI_INFO("RECV_STA_BSSID");
	...
	case ESP_BLUFI_EVENT_RECV_SOFTAP_MAX_CONN_NUM:
		BLUFI_INFO("RECV_SOFTAP_MAX_CONN_NUM");
	...
	case ESP_BLUFI_EVENT_RECV_SOFTAP_AUTH_MODE:
		BLUFI_INFO("RECV_SOFTAP_AUTH_MODE");
	...
	case ESP_BLUFI_EVENT_RECV_SOFTAP_CHANNEL:
		BLUFI_INFO("RECV_SOFTAP_CHANNEL");
	...
	case ESP_BLUFI_EVENT_RECV_SERVER_PRIV_KEY:
        ...
        break;
    default:
    	BLUFI_INFO(" BluFi event not managed: %d", event);
        break;
    }
}
